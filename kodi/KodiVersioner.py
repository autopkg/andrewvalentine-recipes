...
#
# Licensed under the Aparche License, Version 2.0 (the "License");
...
__all__ = ["KodiVersioner.py"]


class KodiVersioner(DmgMounter):
    """Extracts version of Kodi, removing errorneous trailing characters"""
    description = __doc__
    ...
    input_variables = {
        "input_plist_path": {
            "required": True,
            "description":
                ("File path to Kodi plist, inside the .dmg "
        ...
        try:
            ...
            try:
                ...
                if version_key.endswith("."):
                    ...
                    version_key = plist.get(version_key,"UNKNOWN_VERSION")
                #else:
